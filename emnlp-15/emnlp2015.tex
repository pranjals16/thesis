...
The concept of enhanced document vectors give a great boost to classification accuracies on various datasets and hence justifies our claim.
...
Table \ref{table:IMDB} summarizes the results obtained by others and by us on the IMDB movie review dataset. We have gone above the previous best~\cite{Le:14} by a margin of 1.33\% using Enhanced document vector. The main contributor for improvement in results is our Enhanced document vector which overcomes the weaknesses of BOW and document vectors taken separately.

Tables \ref{table:graded_weighting_tfidf} and \ref{table:graded_weighting} demonstrate the effectiveness of our proposed graded weighting technique. Without \emph{tf-idf} features, our proposed method performs better in the graded idf weighting case and when we include \emph{tf-idf} features, 0-1 weighting perform better than idf graded technique and both perform better than the previous state-of-the-art. We see that with larger weights there is a decrease in accuracy and that is because we are now filtering out more words which are important while building document vector.
\begin{table}[H]
\centering
\small
\begin{tabular}{|c|l|l|}
\hline
\multicolumn{1}{|l|}{\textbf{Method}}      & \textbf{Weight} & \textbf{Accuracy} \\ \hline
\multirow{2}{*}{0-1 Weighting}    & 0      & 93.84    \\ \cline{2-3} 
                                  & 1      & \textbf{93.91}    \\ \hline
\multirow{7}{*}{Graded idf Weighting} & 2      & \textbf{93.89}    \\ \cline{2-3} 
                                  & 2.5    & 93.87    \\ \cline{2-3} 
                                  & 2.8    & 93.86    \\ \cline{2-3} 
                                  & 3      & 93.86    \\ \cline{2-3} 
                                  & 4      & 93.83    \\ \cline{2-3} 
                                  ...
                                  & 6      & 93.68    \\ \hline
\end{tabular}
\caption {Results on IMDB Movie Review Dataset using Various Weighting Techniques(Enhanced Document Vector)}
...
\hline
\multicolumn{1}{|l|}{\textbf{Method}}      & \textbf{Weight} & \textbf{Accuracy} \\ \hline
\multirow{2}{*}{0-1 Weighting}    & 0      & 93.06    \\ \cline{2-3} 
                                  & 1      & \textbf{93.18}    \\ \hline
\multirow{7}{*}{Graded idf Weighting} & 2      & 93.17    \\ \cline{2-3} 
                                  & 2.5    & 93.16    \\ \cline{2-3} 
                                  & 2.8    & 93.16    \\ \cline{2-3} 
                                  & 3      & \textbf{93.22}    \\ \cline{2-3} 
                                  & 4      & 93.12    \\ \cline{2-3} 
                                  & 5      & 93.03    \\ \cline{2-3} 
                                  & 6      & 93.00    \\ \hline
\end{tabular}
\caption {Results on IMDB Movie Review Dataset using Various Weighting Techniques(without tf-idf feature)}
\label{table:graded_weighting}
\end{table}
...
\hline
\textbf{Method} & \textbf{Accuracy} \\ \hline
Enhanced Document Vector & 93.91\\ \hline
...
Enhanced Document Vector (Our Method) & 92.17\\ \hline
Enhanced Document Vector + RNNLM (Our Method) & \textbf{92.91}\\ \hline
\end{tabular}
