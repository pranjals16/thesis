...
def makeFeatureVec(words, model, num_features,counter,index2word_set,X):
...
def getAvgFeatureVecs(reviews, model, num_features,X):
    ...
    for review in reviews:
       ...
       #
       reviewFeatureVecs[int(counter)] = makeFeatureVec(review, model, num_features,counter,index2word_set,X)
       #
       counter = counter + 1.
...
if __name__ == '__main__':
	...
	print "Decoded Done!!"
	count_vectorizer = CountVectorizer(ngram_range=(2, 2),max_features=20000,stop_words="english")
	X=count_vectorizer.fit_transform(decoded).toarray()
	'''
	...
	testDataVecs = getAvgFeatureVecs( getCleanReviews(test), model, num_features,X )
